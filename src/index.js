...
async function main() {
  ...
  if (doSummarize || doPreview || doAmend) {
    ...
    // --stt-model deepgram requires DEEPGRAM_API_KEY
    if (sttModel && sttModel.startsWith("deepgram") && !process.env.DEEPGRAM_API_KEY) {
      console.error("Error: DEEPGRAM_API_KEY environment variable is required for --stt-model deepgram");
      console.error("Please add DEEPGRAM_API_KEY=<your-api-key> to your .env file");
      process.exit(1);
    }
  }
